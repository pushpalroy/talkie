...
public class FavPagedListAdapter extends PagedListAdapter<Movie, FavPagedListAdapter.MoviePagedViewHolder> {

    /**
     * An on-click handler that we've defined to make it easy for an Activity to interface with
     * our RecyclerView
     */
    private final FavPagedListAdapterOnClickHandler mOnClickHandler;
     ...
     */
    public interface FavPagedListAdapterOnClickHandler {
     ...
     */
    public FavPagedListAdapter(FavPagedListAdapterOnClickHandler onClickHandler) {
        super(FavPagedListAdapter.DIFF_CALLBACK);
